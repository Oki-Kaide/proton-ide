...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    export * from "types:assemblyscript/util/binary";
    export * from "types:assemblyscript/util/collections";
    export * from "types:assemblyscript/util/math";
    export * from "types:assemblyscript/util/path";
    export * from "types:assemblyscript/util/terminal";
    export * from "types:assemblyscript/util/text";
    export * from "types:assemblyscript/util/vector";
}
declare module "assemblyscript" {
    /**
     ...
     * @license Apache-2.0
     */
    import { Range } from "types:assemblyscript/tokenizer";
    import { DiagnosticCode } from "types:assemblyscript/diagnosticMessages.generated";
    export { DiagnosticCode, diagnosticCodeToString } from "types:assemblyscript/diagnosticMessages.generated";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { DiagnosticMessage, DiagnosticEmitter } from "types:assemblyscript/diagnostics";
    import { Source, CommentKind } from "types:assemblyscript/ast";
    /** Named token types. */
    export enum Token {
        ABSTRACT = 0,
        AS = 1,
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { Class, Program } from "types:assemblyscript/program";
    import { TypeRef } from "types:assemblyscript/module";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { Module, ExpressionRef, FunctionRef, GlobalRef, Index, StringRef } from "types:assemblyscript/module";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { ExpressionRef } from "types:assemblyscript/module";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { Type } from "types:assemblyscript/types";
    import { Local, Function, Element, Field } from "types:assemblyscript/program";
    import { ExpressionRef } from "types:assemblyscript/module";
    import { Node } from "types:assemblyscript/ast";
    ...
    export { findUsedLocals } from "types:assemblyscript/passes/findusedlocals";
}
declare module "assemblyscript" {
    /**
     ...
     * @license Apache-2.0
     */
    import { DiagnosticEmitter } from "types:assemblyscript/diagnostics";
    import { Program, Element, Class, ClassPrototype, Function, FunctionPrototype, Property, PropertyPrototype } from "types:assemblyscript/program";
    import { Flow } from "types:assemblyscript/flow";
    import { TypeNode, TypeName, TypeParameterNode, Node, IdentifierExpression, CallExpression, Expression } from "types:assemblyscript/ast";
    import { Type } from "types:assemblyscript/types";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { CommonFlags } from "types:assemblyscript/common";
    import { Tokenizer, CommentHandler } from "types:assemblyscript/tokenizer";
    import { DiagnosticEmitter, DiagnosticMessage } from "types:assemblyscript/diagnostics";
    import { Node, Source, TypeNode, TypeName, FunctionTypeNode, Expression, ClassExpression, FunctionExpression, Statement, BlockStatement, BreakStatement, ClassDeclaration, ContinueStatement, DecoratorNode, DoStatement, EnumDeclaration, EnumValueDeclaration, ExportImportStatement, ExportMember, ExportStatement, ExpressionStatement, ForOfStatement, FunctionDeclaration, IfStatement, ImportDeclaration, ImportStatement, IndexSignatureNode, NamespaceDeclaration, ParameterNode, ReturnStatement, SwitchCase, SwitchStatement, ThrowStatement, TryStatement, TypeDeclaration, TypeParameterNode, VariableStatement, VariableDeclaration, VoidStatement, WhileStatement, ModuleDeclaration } from "types:assemblyscript/ast";
    class Dependee {
        source: Source;
        reportNode: Node;
...
declare module "assemblyscript" {
     ...
     */
    import { CommonFlags } from "types:assemblyscript/common";
    import { Options } from "types:assemblyscript/compiler";
    import { DiagnosticMessage, DiagnosticEmitter } from "types:assemblyscript/diagnostics";
    import { Type, Signature } from "types:assemblyscript/types";
    import { Token, Range } from "types:assemblyscript/tokenizer";
    import { Source, DecoratorNode, DecoratorKind, TypeParameterNode, TypeNode, NamedTypeNode, FunctionTypeNode, ArrowKind, Expression, IdentifierExpression, Statement, ClassDeclaration, DeclarationStatement, EnumDeclaration, EnumValueDeclaration, FieldDeclaration, FunctionDeclaration, InterfaceDeclaration, NamespaceDeclaration, TypeDeclaration, VariableDeclaration, VariableLikeDeclarationStatement } from "types:assemblyscript/ast";
    import { Module, FunctionRef, MemorySegment } from "types:assemblyscript/module";
    import { Resolver } from "types:assemblyscript/resolver";
    import { Flow } from "types:assemblyscript/flow";
    import { Parser } from "types:assemblyscript/parser";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { Pass } from "types:assemblyscript/passes/pass";
    import { Compiler } from "types:assemblyscript/compiler";
    import { ExpressionRef, TypeRef } from "types:assemblyscript/module";
...
declare module "assemblyscript" {
     ...
     */
    import { Pass } from "types:assemblyscript/passes/pass";
    import { ExpressionRef, FunctionRef, Index, BinaryOp, TypeRef, ExportRef } from "types:assemblyscript/module";
    import { Compiler, Options } from "types:assemblyscript/compiler";
...
declare module "assemblyscript" {
     ...
     */
    import { DiagnosticEmitter } from "types:assemblyscript/diagnostics";
    import { Module, MemorySegment, ExpressionRef, TypeRef, GlobalRef } from "types:assemblyscript/module";
    import { Feature, Target, Runtime } from "types:assemblyscript/common";
    import { Program, ClassPrototype, Class, Element, Enum, Field, Function, Global, Property, VariableLikeElement, File } from "types:assemblyscript/program";
    import { Flow, ConditionKind } from "types:assemblyscript/flow";
    import { Resolver } from "types:assemblyscript/resolver";
    import { Range } from "types:assemblyscript/tokenizer";
    import { Node, FunctionTypeNode, Statement, Expression } from "types:assemblyscript/ast";
    import { Type, Signature } from "types:assemblyscript/types";
    import { ShadowStackPass } from "types:assemblyscript/passes/shadowstack";
    /** Compiler options. */
...
declare module "assemblyscript" {
     ...
     */
    import { Compiler } from "types:assemblyscript/compiler";
    import { Expression, CallExpression } from "types:assemblyscript/ast";
    import { Type } from "types:assemblyscript/types";
    import { ExpressionRef } from "types:assemblyscript/module";
    import { FunctionPrototype, ClassPrototype } from "types:assemblyscript/program";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    import { Target } from "types:assemblyscript/common";
    import * as binaryen from "types:assemblyscript/glue/binaryen";
...
declare module "assemblyscript" {
    import { Element, Function, Enum, Class, Interface, Field, File, Global, Program } from "types:assemblyscript/program";
    /** Walker base class. */
...
declare module "assemblyscript" {
    import { Element, Program, Function, Global, Class, Interface, Enum, Field } from "types:assemblyscript/program";
    import { Type } from "types:assemblyscript/types";
    import { ExportsWalker } from "types:assemblyscript/bindings/util";
...
declare module "assemblyscript" {
    import { Global, Program, Function, Class, Interface, Enum, Field, Element } from "types:assemblyscript/program";
    import { Type } from "types:assemblyscript/types";
    import { ExportsWalker } from "types:assemblyscript/bindings/util";
...
declare module "assemblyscript" {
     ...
     * @license Apache-2.0
     */
    export { JSBuilder } from "types:assemblyscript/bindings/js";
    export { TSDBuilder } from "types:assemblyscript/bindings/tsd";
}
declare module "assemblyscript" {
    /**
     ...
     */
    import { Target, Runtime, Feature } from "types:assemblyscript/common";
    import { Options } from "types:assemblyscript/compiler";
    import { DiagnosticMessage, DiagnosticCategory, formatDiagnosticMessage } from "types:assemblyscript/diagnostics";
    import { Module } from "types:assemblyscript/module";
    import { Program } from "types:assemblyscript/program";
    import { Range } from "types:assemblyscript/tokenizer";
    import { Source } from "types:assemblyscript/ast";
...
declare module "assemblyscript" {
    import "types:assemblyscript/glue/js/index";
    export * from "types:assemblyscript/index-wasm";
    export * from "types:assemblyscript/ast";
    export * from "types:assemblyscript/common";
    export * from "types:assemblyscript/compiler";
    export * from "types:assemblyscript/bindings";
    export * from "types:assemblyscript/diagnostics";
    export * from "types:assemblyscript/flow";
    export * from "types:assemblyscript/module";
    export * from "types:assemblyscript/parser";
    export * from "types:assemblyscript/program";
    export * from "types:assemblyscript/resolver";
    export * from "types:assemblyscript/tokenizer";
    export * from "types:assemblyscript/types";
    export * from "types:assemblyscript/extra/ast";
    import * as util from "types:assemblyscript/util";
    export { util };
}
declare module "assemblyscript" {
    /**
     ...
     */
    export * from "types:assemblyscript/index-js";
    import * as assemblyscript from "types:assemblyscript/index-js";
...
declare module "assemblyscript" {
     ...
     */
    import { Pass } from "types:assemblyscript/passes/pass";
    import { ExportRef, Module } from "types:assemblyscript/module";
    import { Program } from "types:assemblyscript/program";
